...
_ A Firmware program that runs on the robot's computer [Program](https://www.deltaxrobot.com/p/download.html)
_ A camera program that uses OpenCV to detect tomatoes \* A picking program that controls the robot's arm
