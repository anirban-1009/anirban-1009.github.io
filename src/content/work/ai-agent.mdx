...
graph TD
    ...
    style UI fill:#2563eb,stroke:#333,stroke-width:0px,color:#fff
    style API fill:#9333ea,stroke:#333,stroke-width:0px,color:#fff
    style SDK fill:#000,stroke:#fff,stroke-width:1px,color:#fff
    style Vector fill:#10b981,stroke:#333,stroke-width:0px,color:#fff
    style Model fill:#ef4444,stroke:#333,stroke-width:0px,color:#fff
```
