...
metaPath: "/src/images/cover/ai-agent-cover.png"
...
1. **Zero-Latency Retrieval**
   ...
   - **Build Time**: A custom script scans all `.mdx` content, generates embeddings via `gemini-embedding-001`, and compiles them into a optimized `vector-store.json`.
