...
<Mermaid client:idle chart={`graph TD
    ...
    SDK -->|Stream Text| UI
    style User fill:#fff,stroke:#219EBC,stroke-width:2px,color:#000
    style UI fill:#219EBC,stroke:#fff,stroke-width:1px,color:#000
    style API fill:#023047,stroke:#219EBC,stroke-width:1px,color:#fff
    style SDK fill:#08202B,stroke:#219EBC,stroke-width:1px,color:#fff
    style Vector fill:#2C3E50,stroke:#219EBC,stroke-width:0px,color:#fff
    style Model fill:#8E44AD,stroke:#fff,stroke-width:0px,color:#fff`} />
...
This is just V1. The next phase involves giving the agent **Tools**—the ability to navigate the site for you, switch themes, or even send me an email directly.
